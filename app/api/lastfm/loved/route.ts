...
import { assertLastfmAvailable, getLovedTracks, mapLastfmError } from '@/lib/services/lastfmService';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getLovedTracks(request.nextUrl.searchParams);
