...
import { assertLastfmAvailable, getRecentTracks, mapLastfmError } from '@/lib/services/lastfmService';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getRecentTracks(request.nextUrl.searchParams);
